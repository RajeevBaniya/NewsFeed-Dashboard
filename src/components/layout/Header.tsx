      ...
      <div className="px-3 sm:px-4 lg:px-8">
        <div className="flex items-center justify-between h-14 sm:h-16">
          ...
          <button
            ...
            className="lg:hidden p-1.5 sm:p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 
          ...
          <div className="flex items-center space-x-1 sm:space-x-2 lg:space-x-4 flex-shrink-0">
            ...
            >
              <Icon 
                ...
                size="sm" 
                className="text-gray-600 dark:text-white sm:w-5 sm:h-5" 
              />
            </button>
            ...
            <div className="relative" ref={menuRef}>
              ...
              >
                <div className="w-7 h-7 sm:w-8 sm:h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                  <span className="text-white text-xs sm:text-sm font-medium">{(user?.displayName?.[0] || user?.email?.[0] || 'U').toUpperCase()}</span>
                </div>
                {user?.displayName && (
